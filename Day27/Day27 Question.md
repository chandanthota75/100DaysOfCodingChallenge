...
Given an array `A` of size `N`. The value of an array is denoted by the bitwise XOR of all elements it contains. Find the bitwise XOR of the values of all subarrays of A.
